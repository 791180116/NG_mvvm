package com.ng.demo.data.bindadapter
...
import com.ng.demo.app.weight.preference.MyColorCircleView
import ng.crazy.jetpackmvvm.ext.view.textString
...
object CustomBindAdapter {
    ...
    fun imageUrl(view: ImageView, url: String) {
        ...
        /*view.load(url){
            ...
            //transformations(BlurTransformation(view.context,10f,5f))
        }*/
    }
